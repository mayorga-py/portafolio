  ...
  en: {
    translation: {
      ...
      viewluos: {
        ...
        p7: "The official LUOS website available at the following link:",
        p8: "(The images currently displayed correspond to test versions. In the final version, sizes, text, layout, and visual elements may vary.)",
      },
    },
  },
  es: {
    translation: {
      ...
      viewluos: {
        ...
        p7: "El sitio oficial de LUOS esta disponible en la próxima liga: ",
        p8: " (Las imágenes mostradas actualmente corresponden a versiones de prueba. En la versión final pueden variar tamaños, textos, ubicaciones y elementos visuales.)"
      },
    },
  },
};
